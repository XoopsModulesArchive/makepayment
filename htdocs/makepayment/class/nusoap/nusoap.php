...
class XMLSchema extends nusoap_base
{
     ...
     */
    public function XMLSchema($schema = '',$xml = '',$namespaces = [])
    {
        parent::nusoap_base();
...
class soapclient extends nusoap_base
{
     ...
     * @param	int $response_timeout set the response timeout
     */
    public function soapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30)
    {
        parent::nusoap_base();
